     ...
     <% foreach (var item in Model) { %>
        ...
        <tr>
            ...
            <%if (item.iscomplete.Equals(true))
              { %>
                <%: Html.ActionLink("Review Test", "ReviewQuiz", "TestManagement", new { assignment_id = item.id }, null)%>
                <%}
              else
              { %>
                <%: Html.ActionLink("Take Test", "PlayQuiz", "TestManagement", new { assignment_id = item.id }, null)%>
                <%} %>
                </center>
            </td>            
        </tr>
