...
<% using (Html.BeginForm("CreateCaseStudy", "Admin", FormMethod.Post, new { enctype = "multipart/form-data" })){%>
...
<tr style="border:0;">
    ...
    <td style="border:0;">
        <textarea name="question" rows="5"  style="resize:none;"></textarea>
...
<tr style="border:0;">
    <td colspan=2 style="border:0;">
        ...
        <input style="margin:15px 200px 5px 200px;" class="btn-success btn-large" type="submit" value="Submit" />
    </td>
</tr>
</table>
<%} %>