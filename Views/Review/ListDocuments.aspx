...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% foreach (KeyValuePair<int, KotakDocuMentor.Controllers.ReviewController.DocInfo> docucheck in ((Dictionary<int, KotakDocuMentor.Controllers.ReviewController.DocInfo>)ViewData["DocumentList"]))
       { %>
        ...
        <tr>
            ...
            <center>
             <% if (!docucheck.Value.played)
                ...
                {%>
                <%: Html.ActionLink("Review Test", "ReviewDocumentTest", new { docucheck_id = docucheck.Value.id})%>
                <%} %>
            </center>
